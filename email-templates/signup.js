...
const signupTemplate = {
    ...
    async sendMail(request) {
        const patient_code =
            request.patient_code != undefined && request.patient_code != null && request.patient_code != ''
                ? request.patient_code
                : '';
        const doctor_code =
            request.doctor_code != undefined && request.doctor_code != null && request.doctor_code != ''
                ? request.doctor_code
                : '';
        const chemist_code =
            request.chemist_code != undefined && request.chemist_code != null && request.chemist_code != ''
                ? request.chemist_code
                : '';
        const verify_email_url = `${GLOBALS.BASE_DOMAIN_URL}verify/${request.email_verification_token}`;
        const template = `<!DOCTYPE html>
    <html xmlns="http://www.w3.org/1999/xhtml">
        <head>
          <meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
          <meta name="viewport" content="width=device-width, initial-scale=1" />
          <title>${GLOBALS.APP_NAME} - Account Create</title>
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        ...
                                                        background: linear-gradient(to right, #fff 0%, #fff 100%) !important;">
                                                          ...
                                                          <img align="center" alt="Logo" class="kmImage" src="${GLOBALS.APP_LOGO_URL}" width="100" style="border:0;height:auto;line-height:100%;outline:none;text-decoration:none;padding-bottom:0;display:inline;vertical-align:bottom;max-width:199px;" />
                                                        </td>
                                                      </tr>
                                                    </tbody>
                                                  </table>
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="kmTextContent" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#000;font-family:Helvetica, Arial;font-size:14px;line-height:150%;text-align:left;padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
                                                          ...
                                                          <p style="margin:0;padding-bottom:1em"><span style="font-family:arial,helvetica,sans-serif;"><span style="font-size: 16px;">Hello <strong>${request.first_name} ${request.middle_name} ${request.last_name},</strong></p>
                                                          <p style="margin:0;padding-bottom:1em"><span style="font-family:arial,helvetica,sans-serif;font-size: 16px;">Your account has been successfully created on our website. Welcome to Montesereno Health Center.</span></p>
                                                          <p style="margin:0;padding-bottom:1em"><span style="font-family:arial,helvetica,sans-serif;font-size: 16px;">Here are your account details:</p>
                                                          <ul>
                                                            <li><strong>Full Name:</strong> ${request.first_name} ${request.middle_name} ${request.last_name}</li>
                                                            <li><strong>Email:</strong> ${request.email}</li>
                                                            <li><strong>Phone No:</strong> ${request.phone_no}</li>
                                                            <li><strong>Patient Code:</strong> ${patient_code}</li>
                                                            <li><strong>Doctor Code:</strong> ${doctor_code}</li>
                                                            <li><strong>Chemist Code:</strong> ${chemist_code}</li>
                                                            <li><strong>Verification Token:</strong> ${request.email_verification_token}</li>
                                                          </ul>
                                                          
                                                          <p style="margin:0;padding-bottom:1em"><span style="font-family:arial,helvetica,sans-serif;font-size: 16px;"><strong>NOTE: </strong>Please check patient code, doctor code & chemist code for login in our system.</p>

                                                          <p style="text-align: center;margin:0;padding-bottom:1em">
                                                            <span style="font-family:arial,helvetica,sans-serif;">
                                                              <span style="font-size: 16px;">
                                                                <a href="${verify_email_url}" target="_blank" class="btn btn-default" style="color:#fff;background-color:#007bff;border-color: #007bff;display: inline-block;font-weight: 400;text-align: center;white-space: nowrap;vertical-align: middle;border: 1px solid transparent;padding: 0.375rem 0.75rem;font-size: 1rem;line-height: 1.5;border-radius: 0.25rem;transition: color .15s">Click Here</a>
                                                              </span>
                                                            </span>
                                                          </p>
