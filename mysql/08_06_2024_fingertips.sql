...
--
-- Host: localhost
-- Generation Time: Jun 08, 2024 at 09:43 AM
...
INSERT INTO `tbl_categorys` (`id`, `name`, `status`, `is_deleted`, `createdAt`, `updatedAt`) VALUES
(1, 'cloth store', 1, 1, '2024-06-08 06:50:46', '2024-06-08 07:38:38');
...
INSERT INTO `tbl_sub_categorys` (`id`, `category_id`, `name`, `status`, `is_deleted`, `createdAt`, `updatedAt`) VALUES
...
CREATE TABLE `tbl_users` (
  ...
  `password` varchar(255) DEFAULT NULL,
  `en_store_address` varchar(255) DEFAULT NULL,
  `guj_store_address` varchar(255) DEFAULT NULL,
  `en_street` varchar(255) DEFAULT NULL,
  `guj_street` varchar(255) DEFAULT NULL,
  `en_area` varchar(128) DEFAULT NULL,
  `guj_area` varchar(128) DEFAULT NULL,
  `en_pincode` varchar(32) DEFAULT NULL,
  `guj_pincode` varchar(32) DEFAULT NULL,
...
INSERT INTO `tbl_users` (`id`, `language`, `en_full_name`, `guj_full_name`, `email`, `password`, `en_store_address`, `guj_store_address`, `en_street`, `guj_street`, `en_area`, `guj_area`, `en_pincode`, `guj_pincode`, `phone_no`, `country_code`, `profile_image`, `email_verification_token`, `forgot_password_token`, `role`, `login_status`, `app_version`, `whatsapp_number`, `dob`, `store_name`, `gstno`, `en_work_details`, `guj_work_details`, `work_image`, `status`, `otp`, `is_verified`, `is_available`, `is_notification`, `is_deleted`, `last_login`, `verifiedAt`, `createdAt`, `updatedAt`) VALUES
(1, 'English', 'Testing', 'પરીક્ષણ', 'test@gmail.com', '7/W92JwqDduMmNmdfU3GCQ==', 'test address', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1234567890', '91', 'defult.png', NULL, NULL, 0, 'Offline', NULL, '1234567890', '2024-04-01', '', '', '', '', NULL, 0, 0, 0, 1, 1, 0, '2024-04-20 10:47:47', '2024-04-20 10:47:47', '2024-04-20 14:26:15', '2024-06-08 07:07:30'),
(3, 'English', 'vendor testing', 'ટેસ્ટ 2', 'test2@gmail.com', 'vahgscvcs', 'test address', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '11331111111', '91', 'defult.png', NULL, NULL, 1, 'Offline', NULL, '', '0000-00-00', '', '', '', '', NULL, 1, 0, 0, 1, 1, 0, '2024-04-20 11:54:12', '2024-04-20 11:54:12', '2024-04-20 15:26:36', '2024-05-04 17:33:33'),
(4, 'English', 'Service provider', 'ટેસ્ટ 3', 'test3@gmail.com', 'ggahsbhksbda', 'address', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2222222222', '91', 'defult.png', NULL, NULL, 2, 'Offline', NULL, '', '0000-00-00', '', '', '', '', NULL, 1, 0, 0, 1, 1, 0, '2024-04-20 12:25:14', '2024-04-20 12:25:14', '2024-04-20 15:57:53', '2024-05-04 13:42:15'),
(11, 'English', 'user testt', ' ટેસ્ટ ટેસ્ટ', 'usertestt@gmail.com', '/W5Am3G+z33CESBgw+5BBA==', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1111111111', '1', 'defult.png', NULL, NULL, 1, 'Offline', NULL, '123456666', '0000-00-00', '', '', '', '', NULL, 1, 0, 0, 1, 1, 0, '2024-04-28 09:16:50', '2024-04-28 07:52:28', '2024-04-28 07:52:28', '2024-05-04 12:02:46');
